...
const Footer = () => {
    return (
        <div className="bg-gray-800 py-6 px-8 font-sans tracking-wide">
            <div className="flex max-lg:flex-col items-center justify-between gap-x-6 gap-y-8">
                ...
                <p className='text-base text-center text-gray-300  max-lg:order-1'>© ReadymadeUI. All rights reserved.</p>
